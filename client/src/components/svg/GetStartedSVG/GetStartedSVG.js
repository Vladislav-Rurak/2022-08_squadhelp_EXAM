...
const GetStartedSVG = () => (
  <svg
    ...
    style={{ enableBackground: 'new 0 0 384.1 283.3' }}
    xmlSpace='preserve'
    className='injected-svg js-svg-injector'
    dataparent='#SVGctaSection'
    width='208px'
  >
    <style type='text/css'>
    ...
    <g>
      ...
      <clipPath id='abstractShapesID8_2'>
        <use
          xlinkHref='#abstractShapesID8_1'
          style={{ overflow: 'visible' }}
        ></use>
      </clipPath>
      <path
        className='abstract-shapes-8-0 fill-info'
        clipPath='url(#abstractShapesID8_2)'
