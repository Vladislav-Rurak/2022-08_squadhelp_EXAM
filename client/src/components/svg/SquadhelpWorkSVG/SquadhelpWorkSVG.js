...
const SquadhelpWorksSVG = () => (
  ...
  >
    <style type='text/css'>
      {`.app-user-0{fill:#E7EAF3;}
      .app-user-1{fill:#FFFFFF;}
      .app-user-2{fill:#FFFFFF;stroke:#1E2022;}
      .app-user-3{fill:#377DFF;}
      .app-user-4{fill:#1E2022;}
      .app-user-5{fill:none;stroke:#1E2022;}
      .app-user-6{fill:none;stroke:#E7EAF3;}`}
    </style>
    <path
      className='app-user-0 fill-gray-300'
      opacity='.3'
    ...
    ></path>
    <path
      className='app-user-1 fill-white'
    ...
    ></path>
    <path
      className='app-user-5 fill-none stroke-dark'
      strokeWidth='2.5'
      strokeLinecap='round'
    ...
    ></circle>
    <path
      className='app-user-2 fill-white stroke-dark'
      strokeWidth='2.5'
      strokeMiterlimit='10'
    ...
    ></path>
    <circle
      className='app-user-6 fill-none stroke-gray-300'
      strokeWidth='13'
      strokeMiterlimit='10'
      cx='260.1'
      cy='53.5'
...
export default SquadhelpWorksSVG
