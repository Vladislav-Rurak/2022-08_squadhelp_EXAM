...
const LaunchContestSVG = () => (
  ...
  >
    ...
    <path
      className='icon-7-1 fill-gray-400'
      opacity='.5'
    ...
    ></path>
    <path
      className='icon-7-2 fill-primary'
    ...
    <g>
      <path
        className='icon-7-3 fill-none stroke-gray-400'
        strokeWidth='3'
        strokeLinecap='round'
      ...
      ></path>
      <polyline
        className='icon-7-4 fill-none stroke-primary'
        strokeWidth='3'
        strokeLinecap='round'
        strokeLinejoin='round'
        strokeMiterlimit='10'
    ...
    <polygon
      className='icon-7-0 fill-none stroke-white'
      strokeWidth='3'
      strokeLinecap='round'
      strokeLinejoin='round'
      strokeMiterlimit='10'
...
export default LaunchContestSVG
